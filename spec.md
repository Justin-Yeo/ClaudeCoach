...
The one-line digest is generated by Claude as part of the `submit_coaching` tool call (the `post_run_review.digest` field, ≤140 chars) and stored in `runs.claude_digest`. See [prompts/coaching_tool_schema.json](prompts/coaching_tool_schema.json).
